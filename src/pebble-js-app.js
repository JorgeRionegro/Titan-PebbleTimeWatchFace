...
Pebble.addEventListener("showConfiguration",
  function(e) {
    ...
    if (platform=='aplite') {
            Pebble.openURL("https://dl.dropboxusercontent.com/u/34982193/TitanBW_v7_5.html"+url_args);
            console.log("Connected to http configuration page!");
    } else {
            Pebble.openURL("https://dl.dropboxusercontent.com/u/34982193/Titan_v7_5.html"+url_args);
            console.log("Connected to http configuration page!");
    }
  }
);
